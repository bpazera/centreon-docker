...
WORKDIR /root/nagios
ADD https://assets.nagios.com/downloads/nagioscore/releases/nagios-4.1.1.tar.gz /root/nagios/
RUN tar -xzvf nagios-4.1.1.tar.gz

ADD http://www.nagios-plugins.org/download/nagios-plugins-2.1.1.tar.gz /root/nagios/
RUN tar -xzf nagios-plugins-2.1.1.tar.gz

ADD http://downloads.sourceforge.net/project/nagios/ndoutils-2.x/ndoutils-2.0.0/ndoutils-2.0.0.tar.gz?r=http%3A%2F%2Fsourceforge.net%2Fprojects%2Fnagios%2Ffiles%2Fndoutils-2.x%2Fndoutils-2.0.0%2F&ts=1451489905&use_mirror=skylink /root/nagios/
RUN tar -xzf ndoutils-2.0.0.tar.gz

ADD https://s3-eu-west-1.amazonaws.com/centreon-download/public/centreon/centreon-2.6.6.tar.gz /root/nagios/
...
# Now for the plugins
WORKDIR /root/nagios/nagios-plugins-2.1.1
...
# NDOUtils
WORKDIR /root/nagios/ndoutils-2.0.0
...
# Centreon itself
WORKDIR /root/nagios/centreon-2.6.6/
