...
then
	...
	yes n | cp -i /tmp/nagios/nagios/sample-config/cgi.cfg /usr/local/nagios/etc/
	yes n | cp -i /tmp/nagios/nagios/sample-config/resource.cfg /usr/local/nagios/etc/
	cp -r /tmp/nagios/nagios/sample-config/template-object /usr/local/nagios/etc/objects
fi
